 ...
 */
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        ...
        val locationSettingsResponseTalk = settingsClient.checkLocationSettings(builder.build())
        ...
        locationSettingsResponseTalk.addOnFailureListener { exception->
            if(exception is ResolvableApiException && resolve){
                try{
                    ...
                    Log.d("Chats", "Error ${sendEx.message}")
                }
            }else{
                Snackbar.make(
                    binding.activityMapsMain,
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        ...
        ActivityCompat.requestPermissions(this@HuntMainActivity,permissionArray,resultCode)
    }
